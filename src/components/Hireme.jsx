...
const Hireme = () => {
  return (
    <section id="hireme" className="py-10 px-3 text-white">
      ...
      <div className="bg-[#111827] relative px-8 rounded-2xl py-5 lg:max-w-4xl mx-auto min-h-[24rem] mt-24 flex gap-6 lg:flex-row flex-col-reverse items-center border border-white/5">
        <div>
